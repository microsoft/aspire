...
case "${1:-$(uname -m)}" in
    ...
    *) echo "Usage: bash tools/Aspire.Tray.Spike/Mac/publish.sh [osx-arm64|osx-x64]" >&2; exit 1 ;;
esac
...
app="$root/artifacts/bin/Aspire.Tray/Release/net10.0/$rid/app/Aspire Tray.app"
