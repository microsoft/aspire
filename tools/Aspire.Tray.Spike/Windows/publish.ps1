<#
.SYNOPSIS
Publishes the C# NativeAOT Windows tray spike, optionally running its native UI smoke.
.DESCRIPTION
...
than activating the first. There is no signing or installer integration in this spike.
.EXAMPLE
...
$project = Join-Path $PSScriptRoot 'Aspire.Tray.Spike.Windows.csproj'
$repository = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot '../../..'))
$output = Join-Path $repository "artifacts/bin/Aspire.Tray.Spike/publish/win-$Architecture"
