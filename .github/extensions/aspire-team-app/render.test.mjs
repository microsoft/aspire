...
test("renderer theme styles follow canvas tokens with accessible light fallbacks", () => {
  assert.match(STYLES, /--bg: var\(--bgColor-default, var\(--background-color-default, light-dark\(#ffffff, #0d1117\)\)\)/);
  assert.match(STYLES, /--fg: var\(--fgColor-default, var\(--text-color-default, light-dark\(#1f2328, #e6edf3\)\)\)/);
