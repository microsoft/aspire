...
:root {
  ...
  --bg: var(--bgColor-default, var(--background-color-default, light-dark(#ffffff, #0d1117)));
  ...
  --fg: var(--fgColor-default, var(--text-color-default, light-dark(#1f2328, #e6edf3)));
  --muted: var(--fgColor-muted, var(--text-color-muted, light-dark(#656d76, #8b949e)));
  --border: var(--borderColor-default, var(--border-color-default, light-dark(#d0d7de, #30363d)));
  --border-soft: color-mix(in srgb, var(--border), transparent 35%);
  --border-strong: color-mix(in srgb, var(--border), var(--fg) 22%);
  --focus: var(--focus-outlineColor, var(--color-focus-outline, light-dark(#0969da, #58a6ff)));
...
function healthCard(item, index, total, options = {}) {
  ...
  if (item.provider === "azure-devops" && item.discovered) {
    providerContext += " \u00b7 Auto\u2011discovered";
  }
