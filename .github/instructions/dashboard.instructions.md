...
- Reuse or extend the dashboard's Deck primitives for standard interactive controls. Prefer semantic HTML when it provides the required accessibility and behavior without another abstraction.
...
- Use `@onclick:stopPropagation="true"` on interactive elements inside clickable grid or table rows to prevent unintended navigation.
