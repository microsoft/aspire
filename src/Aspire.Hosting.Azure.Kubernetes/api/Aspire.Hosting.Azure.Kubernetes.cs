...
namespace Aspire.Hosting
{
    ...
    public static partial class AzureKubernetesIngressExtensions
    {
        ...
        public static ApplicationModel.IResourceBuilder<Kubernetes.KubernetesGatewayResource> AddGateway(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, string name) { throw null; }

        [AspireExport(Description = "Adds a Kubernetes Ingress resource to an AKS environment")]
        public static ApplicationModel.IResourceBuilder<Kubernetes.KubernetesIngressResource> AddIngress(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, string name) { throw null; }
    }
}
