...
This analyzer package generates bounded polyglot proxies for selected Azure Provisioning SDK types.
...
The generator follows public Azure Provisioning properties, methods, models, and Bicep collections reachable from each selected root. Generated proxies use the shared types from `Aspire.Hosting.Azure.Provisioning` for Bicep values, expressions, and provisionable resources.
