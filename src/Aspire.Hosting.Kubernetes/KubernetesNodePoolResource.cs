...
/// <ats-summary>Represents a Kubernetes node pool as a child resource of a <ats-see cref="!:type:KubernetesEnvironmentResource" />. Node pools can be referenced by compute resources to schedule workloads on specific node pools using <ats-see cref="!:type:KubernetesEnvironmentExtensions.WithNodePool" />.</ats-summary>
[AspireExport]
