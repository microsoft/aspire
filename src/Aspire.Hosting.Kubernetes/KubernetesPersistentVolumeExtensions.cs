...
public static class KubernetesPersistentVolumeExtensions
{
    ...
    /// </code>
    /// </example>
    [AspireExport(Description = "Adds a Kubernetes PersistentVolumeClaim resource")]
    ...
    [AspireExport(Description = "Sets the storage class for a persistent volume")]
    ...
    /// class name.</param>
    /// <returns>The same builder for chaining.</returns>
    [AspireExport("withPvStorageClassParam", Description = "Sets a parameterized storage class for a persistent volume")]
    public static IResourceBuilder<KubernetesPersistentVolumeResource> WithStorageClass(
        this IResourceBuilder<KubernetesPersistentVolumeResource> builder,
    ...
    /// <c>"500Mi"</c>).</param>
    /// <returns>The same builder for chaining.</returns>
    [AspireExport(Description = "Sets the requested storage capacity for a persistent volume")]
    ...
    /// string.</param>
    /// <returns>The same builder for chaining.</returns>
    [AspireExport("withPvCapacityParam", Description = "Sets a parameterized storage capacity for a persistent volume")]
    public static IResourceBuilder<KubernetesPersistentVolumeResource> WithCapacity(
        this IResourceBuilder<KubernetesPersistentVolumeResource> builder,
    ...
    /// <returns>The same builder for chaining.</returns>
    [AspireExport(Description = "Adds an access mode to a persistent volume")]
    ...
    /// <returns>The same builder for chaining.</returns>
    [AspireExport(Description = "Adds a Kubernetes metadata annotation to a persistent volume")]
    ...
    /// <returns>The same builder for chaining.</returns>
    [AspireExport("withVolumeAnnotationParam", Description = "Adds a parameterized Kubernetes metadata annotation to a persistent volume")]
    public static IResourceBuilder<KubernetesPersistentVolumeResource> WithVolumeAnnotation(
        this IResourceBuilder<KubernetesPersistentVolumeResource> builder,
        string key,
    ...
    /// </code>
    /// </example>
    [AspireExport("withKubernetesPersistentVolume", Description = "Binds a workload to a Kubernetes persistent volume by matching volume name")]
    ...
    /// </code>
    /// </example>
    [AspireExport("withKubernetesPersistentVolumeMount", Description = "Binds a workload to a Kubernetes persistent volume and mounts it at a path")]
    public static IResourceBuilder<T> WithPersistentVolume<T>(
        this IResourceBuilder<T> builder,
        IResourceBuilder<KubernetesPersistentVolumeResource> volume,
        string mountPath,
