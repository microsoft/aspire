...
var AtsErrorCodes = struct {
    CapabilityNotFound AtsErrorCode
    HandleNotFound     AtsErrorCode
    TypeMismatch       AtsErrorCode
    InvalidArgument    AtsErrorCode
    ArgumentOutOfRange AtsErrorCode
    CallbackError      AtsErrorCode
    InternalError      AtsErrorCode
}{
