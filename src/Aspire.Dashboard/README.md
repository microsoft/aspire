...
| `Dashboard:Frontend:MaxConsoleLogCount`<br/>Default: `100,000` | An optional limit on the number of console log messages retained in the viewer. When the limit is reached, the oldest messages are removed. |
