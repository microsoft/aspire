...
`hex1b-web-terminal/` vendors `@hex1b/web-terminal` **0.168.0-alpha.1585.1.1de7974**,
paired with the Hex1b NuGet package **0.168.0-alpha.1585.1.1de7974**. The client and server use the evolving
