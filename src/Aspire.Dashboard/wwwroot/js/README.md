...
`hex1b-web-terminal/` vendors `@hex1b/web-terminal` **0.168.0-alpha.1573.1.2917e83**,
paired with the Hex1b NuGet package **0.168.0-alpha.1573.1.2917e83**. The client and server use the evolving
