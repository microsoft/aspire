...
Firefox terminals use `renderer: "webgl2"` until the
...
and iOS `FxiOS/` user-agent tokens and applies to every shared terminal mount,
including automatic retries and explicit reconnects.
