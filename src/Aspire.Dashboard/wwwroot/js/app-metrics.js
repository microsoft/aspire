...
function getThemeColors() {
    ...
    return {
        backgroundColor: style.getPropertyValue("--colorNeutralBackground1"),
        textColor: style.getPropertyValue("--colorNeutralForeground1"),
        pointColor: style.getPropertyValue("--colorBrandBackground")
    };
}
