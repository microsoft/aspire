...
internal static class WellKnownTypeData
{
    public enum WellKnownType
    {
        ...
        Aspire_Hosting_ApplicationModel_IResourceWithConnectionString,
        Aspire_Hosting_ApplicationModel_ConnectionStringReference,
        Aspire_Hosting_ApplicationModel_ContainerResource,
        Aspire_Hosting_ApplicationModel_ExecutableResource,
        Aspire_Hosting_ApplicationModel_ProjectResource,
        Aspire_Hosting_ApplicationModel_IResourceWithoutProjections,
        Aspire_Hosting_ApplicationModel_ResourceExtensions,
        Aspire_Hosting_ResourceProjectionBuilderExtensions,
    ...
    public static string[] WellKnownTypeNames = [
        ...
        "Aspire.Hosting.ApplicationModel.IResourceWithoutProjections",
        "Aspire.Hosting.ApplicationModel.ResourceExtensions",
        "Aspire.Hosting.ResourceProjectionBuilderExtensions",
