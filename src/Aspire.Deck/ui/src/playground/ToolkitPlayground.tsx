  ...
  return (
    <main className="toolkit-playground" data-testid="toolkit-playground">
      <header className="toolkit-playground__header">
        <div>
          <h1>Deck Toolkit</h1>
          <p>shadcn Nova primitives with Aspire density and brand tokens</p>
        </div>
        <IconButton
            ...
            <table className="toolkit-icon-table" data-testid="toolkit-icon-catalog">
              <thead>
                <tr>
                  ...
                  <th scope="col">Lucide regular</th>
                  <th scope="col">Lucide filled</th>
                </tr>
              </thead>
              <tbody>
                {iconNames.map((name) => {
                ...
                <tr data-icon-mapping="UnknownIntegrationIcon">
                  ...
                  <td colSpan={2}>
                    <span className="toolkit-icon-component">
                      ...
                      />
                      <code>Box resource fallback</code>
                    </span>
                  </td>
                </tr>
                <tr data-icon-mapping="UnknownCommandIcon">
                  ...
                  <td colSpan={2}>
                    <span className="toolkit-icon-component">
                      ...
                      />
                      <code>LayoutGrid command fallback</code>
                    </span>
                  </td>
                </tr>
              </tbody>
