...
| METRIC-ROUTES-001 | metrics | `/metrics/resource/{resource}/meter/{meter}/instrument/{instrument}` | PENDING | partial | METRIC-SESSION-001 | Resource, meter, instrument, duration, and view are deep-linkable. |
