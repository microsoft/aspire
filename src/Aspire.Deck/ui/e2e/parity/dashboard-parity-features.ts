...
const featureDefinitions = {
  ...
  metrics: [
    ...
    ["METRIC-DIMENSIONS-001", "/metrics", "Dimension filters and multiple attribute series are discoverable and selectable.", "metrics", "covered", "METRIC-DIMENSIONS-001; DeckApiTests.GetMetrics_ReturnsSummariesAndSeries"],
