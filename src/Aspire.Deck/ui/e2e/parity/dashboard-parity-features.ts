...
const featureDefinitions = {
  ...
  metrics: [
    ...
    ["METRIC-ROUTES-001", "/metrics/resource/{resource}/meter/{meter}/instrument/{instrument}", "Resource, meter, instrument, duration, and view are deep-linkable.", null, "partial", "METRIC-SESSION-001"],
    ...
    ["METRIC-SESSION-001", "/metrics", "Metric selection, duration, view, dimensions, and zoom are restorable.", null, "partial", "METRIC-SESSION-001"],
  ],
