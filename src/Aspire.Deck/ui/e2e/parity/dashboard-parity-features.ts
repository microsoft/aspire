...
const featureDefinitions = {
  ...
  "structured-logs": [
    ...
    ["LOG-ACTIONS-001", "/structuredlogs", "Per-log actions expose details, text/JSON visualizers, copy, and related navigation.", "structured-logs", "partial", "LOG-ACTIONS-001; HTTP-STRUCTURED-LOG-DETAILS-001; STRESS-STRUCTURED-LOG-DETAILS-001"],
