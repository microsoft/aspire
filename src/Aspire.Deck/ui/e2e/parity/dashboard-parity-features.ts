...
const featureDefinitions = {
  ...
  console: [
    ...
    ["CONSOLE-TERMINAL-001", "/consolelogs", "Interactive resources render a terminal and can take or release control.", null, "partial", "CONSOLE-TERMINAL-001; DeckApiTests.GetResources_ReturnsTerminalMetadata (live HMP verification remains)"],
