...
const featureDefinitions = {
  ...
  console: [
    ...
    ["CONSOLE-COMMANDS-001", "/consolelogs", "Commands for the selected resource are available from the console toolbar.", null, "covered", "CONSOLE-COMMANDS-001"],
  ...
  traces: [
    ...
    ["TRACE-SPAN-DETAILS-001", "/traces/detail/{traceId}", "Span details include identifiers, timing, status, attributes, resource, and instrumentation scope.", null, "covered", "TRACE-DETAILS-001; HTTP-TRACES-001; STRESS-TRACES-001"],
