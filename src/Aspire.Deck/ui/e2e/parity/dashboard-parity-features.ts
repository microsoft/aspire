...
const featureDefinitions = {
  ...
  traces: [
    ...
    ["TRACE-TREE-001", "/traces/detail/{traceId}", "The trace detail preserves parent/child span hierarchy and chronological placement.", null, "covered", "TRACE-TREE-001; HTTP-TRACES-001"],
    ["TRACE-EXPAND-001", "/traces/detail/{traceId}", "Trace detail supports individual and expand-all/collapse-all span control.", null, "covered", "TRACE-EXPAND-001"],
