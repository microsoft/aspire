...
const featureDefinitions = {
  ...
  resources: [
    ...
    ["RES-RESOURCE-ICON-001", "/", "Custom Fluent resource icon names override resource-type fallbacks.", null, "covered", "RES-ICON-001; HTTP-RESOURCES-001; STRESS-RESOURCE-ICON-001"],
