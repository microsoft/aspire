export const stressFeatures = {
  ...
  "STRESS-COMMAND-EXECUTE-001": "A Stress resource command executes through the selected versioned or legacy dashboard backend.",
  ...
  "STRESS-TRACES-001": "The React trace page replays live Stress spans and preserves exact scope and resource details.",
