export const dashboardCoreFeatures = {
  ...
  "APP-KEYBOARD-001": "Page, panel, Help, and Settings shortcuts work outside editable controls.",
  ...
  "RES-ICON-001": "Resource and command icons honor Aspire icon names and regular/filled variants.",
  ...
  "CMD-VISIBILITY-001": "Enabled and disabled UI commands render while hidden commands stay absent.",
  "CMD-HIGHLIGHT-001": "At most two highlighted commands render directly and excess highlighted commands remain in overflow.",
  "CMD-DESCRIPTION-001": "Command names and descriptions remain visible and accessible in command surfaces.",
  "CMD-CONFIRM-001": "Commands with confirmation messages require explicit confirmation.",
