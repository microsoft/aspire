export const toolkitFeatures = {
  ...
  "TK-SHELL-001": "The shadcn Nova provider applies Aspire typography, color, radius, and theme tokens.",
  ...
  "TK-STRUCTURED-FILTER-001": "Structured filters compose fields, conditions, values, enabled state, counts, editing, and removal.",
  "TK-GRAPH-001": "Force graphs expose semantic nodes, edges, Lucide icons, selection, zoom, reset, pan, and drag behavior.",
  ...
  "TK-ICON-001": "Named Aspire icons expose their Lucide regular/filled component mapping and fallback behavior.",
  ...
  "TK-SECRET-INPUT-001": "Secret inputs suppress password saving and expose explicit accessible reveal and hide controls.",
