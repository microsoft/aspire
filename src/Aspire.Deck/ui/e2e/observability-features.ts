export const observabilityFeatures = {
  ...
  "CONSOLE-TERMINAL-001": "Terminal-enabled resources render an interactive terminal and can take or release control.",
  "CONSOLE-TERMINAL-FONT-001": "Terminal font size can be increased, decreased, and reset.",
  "CONSOLE-TERMINAL-SIZE-001": "Terminal grid presets update remote columns and rows.",
  ...
  "LOG-GENAI-001": "GenAI log records open the dedicated conversation visualizer.",
  "LOG-TRACE-LINK-001": "A structured log trace ID opens the matching trace and span.",
  "LOG-EXPLAIN-001": "The assistant explains errors from the currently filtered structured logs.",
  ...
  "TRACE-GENAI-001": "GenAI spans open the dedicated conversation visualizer.",
  ...
  "TRACE-EXPLAIN-001": "The assistant explains failures from the currently filtered traces.",
