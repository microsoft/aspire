export const observabilityFeatures = {
  ...
  "LOG-LIST-001": "Structured logs show time, severity, resource, and message for incoming records.",
  "LOG-FILTER-001": "Structured logs filter across resource names and message bodies and expose an empty result.",
  "LOG-SEVERITY-001": "Structured logs filter by every available severity level.",
