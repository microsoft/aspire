...
namespace Aspire.Hosting
{
    ...
    public static partial class BlazorHostedExtensions
    {
        ...
        [AspireExportIgnore(Reason = "Blazor hosted APIs are not yet stable for ATS export.")]
        public static ApplicationModel.IResourceBuilder<T> ProxyBlazorService<T>(this ApplicationModel.IResourceBuilder<T> host, ApplicationModel.IResourceBuilder<IResourceWithServiceDiscovery> service, string apiPrefix = "_api")
            where T : class, ApplicationModel.IDotnetProgramResource, ApplicationModel.IResourceWithEnvironment, IResourceWithServiceDiscovery { throw null; }
        ...
        [AspireExportIgnore(Reason = "Blazor hosted APIs are not yet stable for ATS export.")]
        public static ApplicationModel.IResourceBuilder<T> ProxyBlazorTelemetry<T>(this ApplicationModel.IResourceBuilder<T> host, string otlpPrefix = "_otlp")
            where T : class, ApplicationModel.IDotnetProgramResource, ApplicationModel.IResourceWithEnvironment, IResourceWithServiceDiscovery { throw null; }
        ...
        [AspireExportIgnore(Reason = "Blazor hosted APIs are not yet stable for ATS export.")]
        public static ApplicationModel.IResourceBuilder<T> WithBlazorDebuggerBrowser<T>(this ApplicationModel.IResourceBuilder<T> host, string browser = "msedge")
            where T : class, ApplicationModel.IDotnetProgramResource, ApplicationModel.IResourceWithEnvironment, IResourceWithServiceDiscovery { throw null; }
    }
