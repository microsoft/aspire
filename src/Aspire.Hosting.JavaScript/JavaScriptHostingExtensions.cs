...
public static partial class JavaScriptHostingExtensions
{
    ...
    // of the build context. Unlike the Bun/Node variants this intentionally omits node_modules
    // and npm/yarn/pnpm debug logs: Deno caches remote and npm dependencies under DENO_DIR
    // (/deno-dir) rather than a project-local node_modules folder.
