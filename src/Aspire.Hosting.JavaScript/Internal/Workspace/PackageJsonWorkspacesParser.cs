...
internal static class PackageJsonWorkspacesParser
{
    ...
    ///
    /// The textual content of a package.json file.
    ///
    /// The list of pattern strings declared under workspaces, in declaration order.
    /// Returns an empty list when the document is invalid JSON, has no workspaces
