...
[DebuggerDisplay(@"Type = {GetType().Name,nq}, Resource = {Resource.Name}, ServiceName = {ServiceName ?? ""(default)""}, EndpointNames = {UseAllEndpoints ? ""(All)"" : string.Join("", "", EndpointNames)}")]
