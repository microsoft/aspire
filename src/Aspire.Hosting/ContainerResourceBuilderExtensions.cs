...
public static class ContainerResourceBuilderExtensions
{
    ...
    /// <summary>
    /// Builds the specified container image from Dockerfile content generated by a polyglot callback.
    /// </summary>
    [AspireExport("withDockerfileFactory")]
    internal static IResourceBuilder<T> WithDockerfileFactoryForPolyglot<T>(this IResourceBuilder<T> builder, string contextPath, Func<Task<string>> dockerfileFactory, string? stage = null) where T : ContainerResource
    {
        ArgumentNullException.ThrowIfNull(builder);
        ArgumentNullException.ThrowIfNull(dockerfileFactory);

        return builder.WithDockerfileFactory(contextPath, _ => dockerfileFactory(), stage);
    }
    ...
    /// <summary>
    /// Adds a container resource whose Dockerfile content is generated by a polyglot callback.
    /// </summary>
    [AspireExport("addDockerfileFactory")]
    internal static IResourceBuilder<ContainerResource> AddDockerfileFactoryForPolyglot(this IDistributedApplicationBuilder builder, [ResourceName] string name, string contextPath, Func<Task<string>> dockerfileFactory, string? stage = null)
    {
        ArgumentNullException.ThrowIfNull(builder);
        ArgumentNullException.ThrowIfNull(name);
        ArgumentNullException.ThrowIfNull(dockerfileFactory);

        return builder.AddContainer(name, "placeholder")
                      .WithDockerfileFactoryForPolyglot(contextPath, dockerfileFactory, stage);
    }
