...
public class Program
{
    ...
    internal static async Task<IHost> BuildApplicationAsync(string[] args, CliStartupContext startupContext, Dictionary<string, string?>? configurationValues = null)
    {
        ...
        builder.Services.AddHttpClient(VsCodeExtensionMarketplaceClient.HttpClientName, client =>
        {
            client.Timeout = TimeSpan.FromSeconds(5);
        });
        builder.Services.AddSingleton<IVsCodeExtensionMarketplaceClient, VsCodeExtensionMarketplaceClient>();
