...
public class Program
{
    ...
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            // Profile capture starts before command dispatch so telemetry is configured early.
            // A successful extension handoff transfers export to the delegated child CLI; the
            // parent still disposes its already-started collector in the outer finally block.
