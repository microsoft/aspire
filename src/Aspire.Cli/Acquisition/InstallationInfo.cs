...
/// <c>aspire --info --format json</c>. Each entry corresponds to a single
/// binary either running this process or discovered on the system.
/// </summary>
/// <remarks>
/// <para>
/// The JSON shape is part of the <c>aspire --info --self --format json</c> and
/// <c>aspire --info --format json</c> contracts. Fields use camelCase wire names via
