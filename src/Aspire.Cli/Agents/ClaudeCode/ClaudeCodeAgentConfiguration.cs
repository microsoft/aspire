...
/// </summary>
internal static class ClaudeCodeAgentConfiguration
{
    internal const string HookEventName = "PostToolUse";

    public static AgentClientDescriptor Client { get; } = new(AgentClientKind.ClaudeCode, "claude-code", "Claude Code", GetTargets);
