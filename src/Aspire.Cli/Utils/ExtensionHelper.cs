...
internal static class KnownCapabilities
{
    ...
    // Advertised so tooling can rely on guest AppHost generation writing .codegen-version into
    // the generated modules directory.
    public const string CodeGenerationVersionMarker = "codegen-version-marker.v1";

    /// <summary>
    /// Gets the set of capabilities this CLI advertises to extensions.
    /// </summary>
    public static string[] GetAdvertisedCapabilities() => [DevKit, Project, BuildDotnetUsingCli, Baseline, SecretPrompts, FilePickers, Pipelines, PipelineStepListJson, DescribeIncludeDisabledCommands, LsJsonStream, IsolatedLaunch, LaunchProfile, CodeGenerationVersionMarker];
}
