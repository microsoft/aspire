...
internal abstract class PublishCommandBase : BaseCommand
{
    ...
    protected readonly IDotNetRuntimeSelector _runtimeSelector;
    ...
    protected PublishCommandBase(string name, string description, IDotNetCliRunner runner, IInteractionService interactionService, IProjectLocator projectLocator, AspireCliTelemetry telemetry, IDotNetRuntimeSelector runtimeSelector, IFeatures features, ICliUpdateNotifier updateNotifier)
    ...
    protected override async Task<int> ExecuteAsync(ParseResult parseResult, CancellationToken cancellationToken)
    {
        ...
        if (!await SdkInstallHelper.EnsureSdkInstalledAsync(_interactionService, _runtimeSelector, cancellationToken))
        {
