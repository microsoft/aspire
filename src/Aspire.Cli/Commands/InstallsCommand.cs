...
internal sealed record InstallListItem(string Id, string Kind, string? Channel, string? Path, string? Hive, string Status, string? StatusReason, string? ManagedBy);
