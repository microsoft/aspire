...
internal sealed class DeckLauncher(LayoutProcessRunner layoutProcessRunner, IEnvironment environment)
{
    ...
    /// </summary>
    public Task<IProcessExecution> StartAsync(string deckPath, DeckLaunchInfo info, IDictionary<string, string>? extraEnvironment = null, ProcessInvocationOptions? options = null)
    {
        ...
        return layoutProcessRunner.StartAsync(deckPath, [], environmentVariables: environmentVariables, options: options);
    }
