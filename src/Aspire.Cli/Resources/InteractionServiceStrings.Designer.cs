...
namespace Aspire.Cli.Resources {
    ...
    public class InteractionServiceStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Required input {0} was not provided in non-interactive mode. Specify the value with the {1} option..
        /// </summary>
        public static string NonInteractiveRequiredInputMissingWithOption {
            get {
                return ResourceManager.GetString("NonInteractiveRequiredInputMissingWithOption", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to Required input {0} was not provided in non-interactive mode. Specify the value with the {1} or {2} option..
        /// </summary>
        public static string NonInteractiveRequiredInputMissingWithOptions {
            get {
                return ResourceManager.GetString("NonInteractiveRequiredInputMissingWithOptions", resourceCulture);
            }
        }

        /// <summary>
        ///   Looks up a localized string similar to Required parameter {0} was not provided in non-interactive mode. Specify the value with the {1} option..
        /// </summary>
        public static string NonInteractiveRequiredParameterMissingWithOption {
            get {
                return ResourceManager.GetString("NonInteractiveRequiredParameterMissingWithOption", resourceCulture);
            }
        }
