...
internal sealed partial class IsolatedProcess
{
    ...
    {
        // StartDetached/CreateNewProcessGroup do not create the independent hidden console
        // required for targeted CTRL+C delivery. Keep CREATE_NEW_CONSOLE for this launch mode.
