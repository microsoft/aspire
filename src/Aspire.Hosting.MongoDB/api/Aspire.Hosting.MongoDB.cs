...
namespace Aspire.Hosting
{
    public static partial class MongoDBBuilderExtensions
    {
        ...
        [AspireExport]
        public static ApplicationModel.IResourceBuilder<ApplicationModel.MongoDBServerResource> WithRepl(this ApplicationModel.IResourceBuilder<ApplicationModel.MongoDBServerResource> builder) { throw null; }

        [AspireExport]
        [System.Diagnostics.CodeAnalysis.Experimental("ASPIREMONGODB001", UrlFormat = "https://aka.ms/aspire/diagnostics/{0}")]
        public static ApplicationModel.IResourceBuilder<ApplicationModel.MongoDBServerResource> WithReplicaSet(this ApplicationModel.IResourceBuilder<ApplicationModel.MongoDBServerResource> builder, string? name = null) { throw null; }
