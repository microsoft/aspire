...
string projectConnectionString = Environment.GetEnvironmentVariable("ConnectionStrings__projmyproject16")
    ?? throw new InvalidOperationException("ConnectionStrings__projmyproject16 is not set.");
...
{
    throw new InvalidOperationException("ConnectionStrings__projmyproject16 contains an invalid Endpoint value.");
}
