...
await bingTool2.withBingResourceIdReference('/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/rg/providers/Microsoft.Bing/accounts/bing');
...
await bingTool3.withBingParameterReference(bingParam);
