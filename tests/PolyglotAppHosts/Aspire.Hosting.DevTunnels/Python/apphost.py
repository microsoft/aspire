...
with create_builder() as builder:
    ...
    tunnel.with_tunnel_reference(web_endpoint)
    ...
    tunnel2.with_tunnel_reference_anonymous(web2_endpoint, True)
    ...
    tunnel3.with_tunnel_reference_all(web3, False)
    ...
    tunnel4.with_tunnel_reference(web4_endpoint)
    _tunnel_endpoint = tunnel4.get_tunnel_endpoint(web4_endpoint)
