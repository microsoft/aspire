export interface TestHandlePropertyContext {
    ...
    optionalResource: { get: () => Promise<TestResourceContext | null>; set: (value: Awaitable<TestResourceContext | null>) => Promise<void> };
    ...
    optionalContext: { get: () => Promise<TestEnvironmentContext | null>; set: (value: Awaitable<TestEnvironmentContext | null>) => Promise<void> };
