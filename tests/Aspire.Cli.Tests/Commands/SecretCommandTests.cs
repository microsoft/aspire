...
public class SecretCommandTests(ITestOutputHelper outputHelper)
{
    ...
    private sealed class TestAppHostProject(string userSecretsId) : IAppHostProject
    {
        ...
        public Task<AppHostValidationResult> ValidateAppHostAsync(FileInfo appHostFile, CancellationToken cancellationToken, bool noEvaluate = false) => throw new NotSupportedException();
