...
builder.Build().Run();");
    ...
    {
        // The discovery walk folds the AppHost configured in a parent directory into its results, so an
        // explicitly-named directory could otherwise "find" a project that is not under it at all.
