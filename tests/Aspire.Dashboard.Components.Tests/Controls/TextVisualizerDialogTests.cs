...
public class TextVisualizerDialogTests : DashboardTestContext
{
    ...
    public async Task Render_TextVisualizerDialog_WithValidJson_FormatsJsonAsync()
    {
        ...
        Assert.Equal([DashboardUIHelpers.JsonFormat, DashboardUIHelpers.PlaintextFormat, DashboardUIHelpers.SqlFormat], instance.EnabledOptions.ToImmutableSortedSet());
    }
    ...
    public async Task Render_TextVisualizerDialog_WithValidXml_FormatsXml_CanChangeFormatAsync()
    {
        ...
        Assert.Equal([DashboardUIHelpers.PlaintextFormat, DashboardUIHelpers.SqlFormat, DashboardUIHelpers.XmlFormat], instance.EnabledOptions.ToImmutableSortedSet());
