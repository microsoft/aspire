...
/// <summary>
/// End-to-end tests for deploying Azure Key Vault resources via Aspire.
/// Tests the Aspire.Hosting.Azure.KeyVault integration package.
/// </summary>
public sealed class AzureKeyVaultDeploymentTests(ITestOutputHelper output)
{
    ...
    [Fact]
    public async Task DeployAzureKeyVaultResource()
    {
        ...
        await DeployAzureKeyVaultResourceCore(cancellationToken);
    }

    private async Task DeployAzureKeyVaultResourceCore(CancellationToken cancellationToken)
    {
        ...
        var resourceGroupName = DeploymentE2ETestHelpers.GenerateResourceGroupName("keyvault");

        output.WriteLine($"Test: {nameof(DeployAzureKeyVaultResource)}");
...
""";
            ...
            DeploymentReporter.ReportDeploymentSuccess(
                nameof(DeployAzureKeyVaultResource),
                resourceGroupName,
