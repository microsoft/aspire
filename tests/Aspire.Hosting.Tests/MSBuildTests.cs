...
public class MSBuildTests
{
    ...
    private static string CreateSdkBundleAppHostProject(string basePath, string repoRoot, string additionalProperties, string additionalProjectReferences = "", string additionalTargets = "")
    {
