...
param my_long_env_name_acr_pull_identity_outputs_id string
...
output AZURE_CONTAINER_REGISTRY_MANAGED_IDENTITY_ID string = my_long_env_name_acr_pull_identity_outputs_id
