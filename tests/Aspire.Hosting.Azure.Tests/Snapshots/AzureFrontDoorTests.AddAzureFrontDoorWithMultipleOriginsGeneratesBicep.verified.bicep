...
resource apiEndpoint 'Microsoft.Cdn/profiles/afdEndpoints@2025-06-01' = {
  name: take('apiendpoint${uniqueString(resourceGroup().id)}', 24)
  location: 'Global'
  parent: frontdoor
}

resource apiOriginGroup 'Microsoft.Cdn/profiles/originGroups@2025-06-01' = {
  name: take('apiorigingroup${uniqueString(resourceGroup().id)}', 24)
  properties: {
...
resource apiOrigin 'Microsoft.Cdn/profiles/originGroups/origins@2025-06-01' = {
  name: take('apiOrigin-${uniqueString(resourceGroup().id, api_host)}', 24)
  properties: {
    hostName: api_host
...
resource apiRoute 'Microsoft.Cdn/profiles/afdEndpoints/routes@2025-06-01' = {
  name: take('apiroute${uniqueString(resourceGroup().id)}', 24)
  properties: {
    originGroup: {
...
resource webEndpoint 'Microsoft.Cdn/profiles/afdEndpoints@2025-06-01' = {
  name: take('webendpoint${uniqueString(resourceGroup().id)}', 24)
  location: 'Global'
  parent: frontdoor
}

resource webOriginGroup 'Microsoft.Cdn/profiles/originGroups@2025-06-01' = {
  name: take('weborigingroup${uniqueString(resourceGroup().id)}', 24)
  properties: {
    loadBalancingSettings: {
      sampleSize: 4
      successfulSamplesRequired: 3
...
resource webOrigin 'Microsoft.Cdn/profiles/originGroups/origins@2025-06-01' = {
  name: take('webOrigin-${uniqueString(resourceGroup().id, web_host)}', 24)
  properties: {
    hostName: web_host
...
resource webRoute 'Microsoft.Cdn/profiles/afdEndpoints/routes@2025-06-01' = {
  name: take('webroute${uniqueString(resourceGroup().id)}', 24)
  properties: {
    originGroup: {
