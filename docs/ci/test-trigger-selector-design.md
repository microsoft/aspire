...
- **Audited loose paths:** reusable workflow implementations, CI data/scripts,
  and other Layer-1-blind inputs have regression cases that assert their
  specific consumer is selected without falling back to `ALL`.
