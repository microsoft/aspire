...
| `ASPIREAZUREPROVISIONING005` | Warning | A selected Azure Provisioning proxy root is not a supported non-generic, non-static class. | [src/Aspire.Hosting.Azure.Provisioning.Generators/AspireProvisioningProxyGenerator.cs](../src/Aspire.Hosting.Azure.Provisioning.Generators/AspireProvisioningProxyGenerator.cs) |
