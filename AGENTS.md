...
Do not request manual mappings for ordinary .NET source and test files that the
selector's ProjectGraph-based Layer 1 already owns. For Layer 2 blind spots,
