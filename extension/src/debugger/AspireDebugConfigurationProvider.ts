...
import { appHostLifecycleLaunchAlreadyClaimed, appHostLifecycleLaunchProfileRequiresRun, defaultConfigurationName, defaultConfigurationNameForWorkspaceFolder } from '../loc/strings';
