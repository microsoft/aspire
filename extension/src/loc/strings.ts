...
export const azureFunctionsCmdDelayedExpansion = vscode.l10n.t('Azure Functions launch arguments are not supported when cmd.exe delayed environment variable expansion is enabled. Remove "/v:on" from the configured terminal profile or use PowerShell and try again.');
