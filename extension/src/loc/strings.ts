...
export const cmdShimPercentArgument = vscode.l10n.t('Percent-delimited arguments cannot be passed safely to a Windows command shim. Configure aspire.aspireCliExecutablePath to use aspire.exe and try again.');
