...
export const launchingWithDirectory = (sessionType: 'run' | 'debug', appHostPath: string) => vscode.l10n.t('Launching Aspire {0} session using directory {1}: attempting to determine effective AppHost...', sessionType, appHostPath);
export const launchingWithAppHost = (sessionType: 'run' | 'debug', appHostPath: string) => vscode.l10n.t('Launching Aspire {0} session for AppHost {1}...', sessionType, appHostPath);
