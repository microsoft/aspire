...
export type AspireExtensionE2EControlCommand =
    ...
    | { name: 'executeResourceCommandItem'; appHostPath?: string; resourceName: string; commandName: string; filePickerPaths?: readonly string[] }
    | { name: 'executeCodeLensResourceAction'; appHostPath?: string; resourceName: string; commandName: string; filePickerPaths?: readonly string[] }
