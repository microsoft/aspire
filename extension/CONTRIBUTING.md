...
ASPIRE_EXTENSION_E2E_SHARD=build-ownership ASPIRE_EXTENSION_E2E_SPEC=out/test-e2e/test-e2e/buildOwnership.e2e.test.js ASPIRE_EXTENSION_E2E_CLI_PATH=/path/to/aspire corepack yarn test:e2e
