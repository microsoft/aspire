...
function assertGeneratedProjectTargetsNet10(projectPath) {
  ...
  if (targetFramework !== 'net10.0') {
    throw new Error(`The installed .NET template generated ${projectPath} with target framework '${targetFramework ?? '<missing>'}', but the browser debugger E2E fixture requires net10.0.`);
  }
}
