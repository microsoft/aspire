...
- The output is a zip archive (default name `aspire-export-<timestamp>.zip`) containing up to five directories:
  ...
  - `metrics/` — one JSON file per resource with metrics data in OTLP format.
