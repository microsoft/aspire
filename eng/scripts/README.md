...
- **Tool mode** installs the PR's `Aspire.Cli` dotnet-tool package from the RID-specific NuGet artifact. Use this when validating dotnet-tool packaging or acquisition behavior.
